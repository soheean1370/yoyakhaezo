...
if "result" not in st.session_state:
    ...
    st.session_state["result"] = {
        "summary": "이 카드는 전월 실적 조건을 충족하면 주요 생활 영역에서 할인 혜택을 받을 수 있는 상품입니다. 다만 혜택별 월 할인 한도와 제외 업종이 존재하므로 가입 전 조건을 확인해야 합니다.",
        "important_sentences": [
            "전월 이용금액 30만 원 이상 충족 시 주요 혜택이 제공됩니다.",
            "할인 혜택은 월 통합 한도 내에서 적용됩니다.",
            "일부 가맹점과 특정 결제 방식은 혜택 대상에서 제외될 수 있습니다.",
            "무이자할부, 세금, 상품권 구매 금액은 전월 실적에서 제외될 수 있습니다.",
            "카드 해지 시 연회비 반환 조건을 확인해야 합니다.",
        ],
    }
...
def get_important_sentences(result):
    """
    요약 결과에서 중요 문장을 가져오는 함수
    """
    return result.get("important_sentences", [])
